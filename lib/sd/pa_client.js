...
function pa_client_revoke(module,item,amount_str,immediate_str) {
	...
	log_verbose("revoking: module: %s, item: %s, amount: %s, immediate: %s\n", module, item, amount, immediate);
	...
	return func(item,amount,immediate);
}
