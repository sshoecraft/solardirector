...
#include "client.h"
#include "auth.h"     // Crypto support (Digest, MD5)
...
uint32_t HTTPClientAddRequestHeaders (HTTP_SESSION_HANDLE pSession,
...
uint32_t HTTPClientSendRequest (HTTP_SESSION_HANDLE pSession,
                              CHAR *pUrl,           //  [IN] The requested URL
                              VOID *pData,          //  [IN] Data to post to the server
                              uint32_t nDataLength,   //  [IN] Length of posted data
                              BOOL TotalLength,     //  [IN] 
                              uint32_t nTimeout,      //  [IN] Operation timeout
                              uint32_t nClientPort)   //  [IN] Client side port 0 for none
{
...
uint32_t HTTPClientWriteData (HTTP_SESSION_HANDLE pSession, 
                            VOID *pBuffer, 
...
///////////////////////////////////////////////////////////////////////////////
                            ...
                            uint32_t HTTPClientReadData (HTTP_SESSION_HANDLE pSession,
                                ...
                                uint32_t nTimeout,         // [IN]     operation timeout in seconds
...
uint32_t HTTPIntrnSetURL (P_HTTP_SESSION pHTTPSession,
...
uint32_t HTTPIntrnResizeBuffer (P_HTTP_SESSION pHTTPSession,
...
uint32_t HTTPIntrnHeadersRemove (P_HTTP_SESSION pHTTPSession,
...
uint32_t HTTPIntrnHeadersAdd (P_HTTP_SESSION pHTTPSession,
                            CHAR *pHeaderName,   // [IN] The header's name
...
uint32_t HTTPIntrnSend (P_HTTP_SESSION pHTTPSession,
...
uint32_t HTTPIntrnRecv (P_HTTP_SESSION pHTTPSession,
...
uint32_t HTTPIntrnHeadersFind (P_HTTP_SESSION pHTTPSession,CHAR *pHeaderName,
...
uint32_t HTTPIntrnHeadersSend(P_HTTP_SESSION pHTTPSession,
...
uint32_t HTTPIntrnHeadersReceive (P_HTTP_SESSION pHTTPSession,
                                uint32_t nTimeout)        // [IN] Timeout for the operation
