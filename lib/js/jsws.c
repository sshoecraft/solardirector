...
error
Fired when a connection with a WebSocket has been closed because of an error, such as when some data couldnt be sent. Also available via the onerror property.
