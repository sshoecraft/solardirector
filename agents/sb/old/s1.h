...
sb_string_t strings[] = {
	...
	{ "7584t","Germany, Low Voltage Directive for generators > 4.6 kVA" },
	{ "7585","[DE] VDE-AR-N4105:2018 Storage > 4.6 kVA" },
	{ "7585t","Germany, Low Voltage Directive for storage > 4.6 kVA" },
	{ "7586","[DE] VDE-AR-N4105:2018 Generators up to 4.6 kVA" },
	{ "7586t","Germany, Low Voltage Directive for generators up to 4.6 kVA" },
	{ "7587","[DE] VDE-AR-N4105:2018 Storage up to 4.6 kVA" },
	{ "7587t","Germany, Low Voltage Directive for up to 4.6 kVA" },
	{ "7588","[DE] VDE-AR-N4110:2018 Generator int. Decoup. Protection Device" },
	{ "7588t","Germany, Medium Voltage Directive for generators with internal decoupling protection" },
	{ "7589","[DE] VDE-AR-N4110:2018 Generator ext. Decoup. Protection Device" },
	{ "7589t","Germany, Medium Voltage Directive for generators with external decoupling protection" },
	{ "7590","[EU] EN50549-1:2018 LV" },
	{ "7590t","Europe, Requirements for generators connected to LV distribution network" },
	{ "7591","[EU] EN50549-2:2018 MV" },
	{ "7591t","Europe, Requirements for generators connected to MV distribution network" },
	{ "7592","SMA Default 2019 50Hz" },
	{ "7592t","Default country dataset for 50Hz networks" },
	{ "7593","SMA Default2019 60Hz" },
	{ "7593t","Default country dataset for 60Hz networks" },
	{ "7594","[UK] ENA-EREC-G98/1:2018" },
	{ "7594t","Great Britain, Requirements for generators with max. 16 A per phase" },
	{ "7595","[UK] ENA-EREC-G99/1:2018" },
	{ "7595t","Great Britain, Requirements for generators with max. 16 A per phase" },
	{ "7596","[BE] C10/11-LV1:2018 LV up to 10kVA" },
	{ "7596t","Belgium, generators on low-voltage grid up to 10 kVA (up to 5 kVA single-phase)" },
	{ "7597","[BE] C10/11-LV2:2018 LV >10kVA" },
	{ "7597t","Belgium, generators on low-voltage grid >10 kVA" },
	{ "7598","[BE] C10/11-MV1:2018 MV" },
	{ "7598t","Belgium, generators on high-voltage grid up to 25 MW" },
	{ "7599","[DK] Dansk Energi DK1:2019 LV" },
	{ "7599t","Denmark, generators on low voltage grid, West Denmark (DK2) " },
	{ "7600","[DK] Dansk Energi DK2:2019 LV" },
	{ "7600t","Denmark, generators on low voltage grid, East Denmark (DK2) " },
	...
	{ "7602t","Belgien, Generator at low-voltage grid, Internal  Decoupling Protection Device" },
	{ "7603","[BE] Synergrid C10/11:2019 LV Generators ext. Decoup. Protection Device" },
	{ "7603t","Belgien, Generator at low-voltage grid, External Decoupling Protection Device" },
	{ "7604","[BE] Synergrid C10/11:2019 MV Generators int. Decoup. Protection Device" },
	{ "7604t","Belgien, Generator at high-voltage grid, Internal Decoupling Protection Device" },
	{ "7605","[BE] Synergrid C10/11:2019 MV Generators ext. Decoup. Protection Device" },
	{ "7605t","Belgien, Generator at high-voltage grid, External Decoupling Protection Device" },
	{ "7606","[BE] Synergrid C10/11:2019 LV Storage int. Decoup. Protection Device" },
	{ "7606t","Belgien, Storage at low-voltage grid, Internal  Decoupling Protection Device" },
	{ "7607","[BE] Synergrid C10/11:2019 LV Storage ext. Decoup. Protection Device" },
	{ "7607t","Belgien, Storage at low-voltage grid, External Decoupling Protection Device" },
	{ "7608","[BE] Synergrid C10/11:2019 MV Storage int. Decoup. Protection Device" },
	{ "7608t","Belgien, Storage at high-voltage grid, Internal Decoupling Protection Device" },
	{ "7609","[BE] Synergrid C10/11:2019 MV Storage ext. Decoup. Protection Device" },
	{ "7609t","Belgien, Storage at high-voltage grid, External Decoupling Protection Device" },
	{ "7610","[IT] CEI0-21:2019 System 11.08 kW int. Decoup. Protection Device" },
	{ "7610t","Italy, systems in low-voltage grids, up to 11,08 kW, with internal decoupling protection device" },
	{ "7611","[IT] CEI0-21:2019 System 11.08 kW ext. Decoup. Protection Device" },
	{ "7611t","Italy, systems in low-voltage grids, up to 11,08 kW, with internal decoupling protection device" },
	{ "7612","[IT] CEI0-21:2019 System >11.08 kW ext. Decoup. Protection Device" },
	{ "7612t","Italy, systems in low-voltage Grids, higher than 11,08 kW, with external decoupling protection device" },
	{ "7613","[IT] CEI0-16:2019 System 6 MW" },
	{ "7613t","Italy, systems in medium or high-voltage Grids, up to 6 MW" },
	{ "7614","[AT] TOR Erzeuger Typ A V1.0:2019" },
	{ "7615","[AT] TOR Generator Type A V1.0:2019" },
	{ "7615t","Austria, Generators or Storage Typ A, in low-voltage grids, up to 250 kW" },
	{ "7616","[AT] TOR Generator Type B V1.0:2019 System >250kW" },
	{ "7616t","Austria, Generators or Storage Typ B, in medium-voltage grids, higher than 250 kW up to 35 MW" },
	...
	{ "10921t","relative to rated capacity (SOH)" },
	...
	{ "lHour","Hour" },
	{ "lHours","hours" },
	{ "eMaximumCountGGLoginTrysAccomplished","An incorrect SMAGridGuard code has been repeatedly entered. For security reasons, the SMAGridGuard login is temporarily blocked.<br /><br />Wait {{time}} and then try again." },
	{ "hMaximumCountGGLoginTrysAccomplished","SMAGridGuard login is temporarily blocked." },
	{ "bCancel","Cancel" },
	{ "lGridGuardLogin","SMAGridGuard login" },
	{ "lGridGuardLoginText","You can only change the SMAGridGuard parameters with your personal access code. Any change to SMAGridGuard parameters must be approved by the grid operator." },
	{ "lGridGuardLoginPwFailed","The entered SMAGridGuard code is incorrect. Please correct your entry." },
	{ "lGridGuardCodeMissing","Enter your personal SMAGridGuard code." },
	{ "lGridGuardPlaceholder","SMAGridGuard code" },
	...
	{ "hHintGridGuardCode","Information: In order to configure the device, you require a personal SMAGridGuard code (application form is available at  <a href='http://www.SMA-Solar.com'>www.SMA-Solar.com</a>)." },
	...
	{ "hConfigureNetwork","You can integrate the product, depending on its features, either into your local network via Ethernet using a cable or wireless via WLAN. Select the respective option under <b>Type of communication</b>." },
	...
	{ "hCountrySetting","Selecting the Country Data Set" },
	{ "hCountrySettingsHelp","The country data set contains special default settings of the device parameters on the grid side to meet the corresponding grid-connection standard.<br />If you select a country data set, the device will be configured with the corresponding default settings." },
	{ "oChooseCountrySetting","Select the desired country data set." },
	{ "oInsertGGLogin","Enter your personal SMAGridGuard code." },
	{ "lProcedure","<b>Procedure</b>" },
	{ "hGridGuardLoginNecessary","In order to change the current country data set, you must additionally log in with your personal SMAGridGuard code." },
	...
	{ "oChooseContextMenuEnergyMeter","In the table <b>SMAEnergyMeters found</b>, select the following button for the desired SMAEnergyMeter:" },
	{ "oChooseUsedEnergyMeter","In the context menu, select <b>Use SMAEnergyMeter in the system</b>. The SMAEnergyMeter will be added to your system as installed SMAEnergyMeter." },
	...
	{ "hGridGuardCodeMissing","You must enter your personal SMAGridGuard code before proceeding." },
	...
	{ "lConfigEinspeiseManagementWechselrichter","Active power setpoint" },
	...
	{ "lEinspeisemAmNetzanschluss","Grid connection point regulation" },
	{ "bToggleBlindleistung_Ein","On" },
	{ "bToggleBlindleistung_Aus","Off" },
	{ "hContentStatischeSpannungshaltung","Upon activation, the inverter provides reactive power by means of the set operating mode.<br />In case of manual input, you must enter the nominal value specified by the grid operator in VAr or in percent.<br />In case of external specification, the inverter receives the setpoint through a higher control unit. You must enter the dynamic behavior for the implementation of the setpoint and the specified disengaging value for the absent setpoint.<br />When selecting a characteristic curve process, the characteristic curve is preconfigured as per country standard. You can make adjustments after completing the installation assistant via the menu %u201EGerteparameter%u201C. Coordinate the configuration with your grid operator." },
	{ "hInfotextKennlinie","Characteristic curve was configured according to the set country standard. Changes or more settings can also be configured via the device parameters." },
	{ "lPowerControlModule","Active power setpoint via SMA I/O module" },
	{ "lPreDIHeader","D" },
	...
	{ "hSensorModuleEnergyMeterS0","Enter the current meter reading of the energy meter used in the field \"S0 meter reading Total yield\". In the field \"S0 pulses\", you must enter the number of S0 pulses per kWh defined by the manufacturer of the energy meter. This ensures that the SensorModule receives the data of the energy meter correctly." },
	...
	{ "hSensorModuleWindSensor","Enter the number of S0 pulses per m/s defined by the manufacturer of the anemometer in the field \"S0 pluses per m/s. This ensures that the SensorModule receives the data of the anemometer correctly." },
	...
	{ "iSaveNotCompleteInsufficientDcPower","The DC voltage of the inverter is currently too low or a component is being updated. As a result, the settings could not yet be saved completely.<br /><br />As soon as sufficient DC voltage is available again or the update is completed, the settings will be saved completely." },
	...
	{ "tPasswordRules","Password guideline<ul><li>8 to 12 characters<br /><li>At least 1 lower or upper case letter<br /><li>At least 1 digit<br /><li>Possible special characters: ?_!-<br /></ul>" },
	...
	{ "tLoginGridGuard","In order to change this parameter, you must log in with your personal SMAGridGuard code in the menu <b>User settings</b>." },
	...
	{ "hAddEnergyMeter","Add a detected SMAEnergyMeter to the system. The SMAEnergyMeter is used as purchased electricity meter and feed-in meter." },
	...
	{ "lAlreadyGridGuardRights","You are already logged in with SMAGridGuard rights." },
	...
	{ "iFwUpdateFailedManual","An error has occurred.<br />The firmware could not be updated.<br />Contact the ServiceLine." },
	{ "iSaveConfigToFile","You can save the current configuration of the device in a file. <br />You can use the file as backup and, if required, import it then to this or other devices of the same type. No passwords - only the device parameters are saved in the file." },
	...
	{ "iLoadConfigFromFile","In order to be able to adopt a configuration for this device, you have to transfer the configuration file." },
	{ "iLoadConfigGridGuard","In addition, for certain devices you require your personal SMAGridGuardcode for authentication (application form is available at  <a href='http://www.SMA-Solar.com'>www.SMA-Solar.com</a>)." },
	{ "iLoadConfigDCInfo","To completely adopt the configuration, a certain DC input voltage is required for some devices. If the DC input voltage is currently too low, the configuration is only completely adopted once sufficient DC input voltage is present." },
	{ "lLoadConfigFile","Adopt the configuration from a file" },
	{ "oChooseFile","Select the desired file:" },
	{ "bSearchFile","Browse..." },
	{ "bImportFile","Import file" },
	{ "oGridGuard","Enter your personal SMAGridGuard code:" },
	...
	{ "hGridGuardCodeMissingHeader","SMAGridGuard code required" },
	...
	{ "hIslandCountryHelpHeader","Selecting the Country Data Set" },
	...
	{ "lTigoPortalInfo","Logging has been started!<br />One moment please...<br />When the logging process is completed, the TS4 components are available in SunnyPortal after a waiting time of 10 minutes." },
	...
	{ "hContentHelpKiteTest","The battery functional test comprises the tests: <b>Battery charging</b> and <b>battery discharging</b>. The tests can be performed in any sequence. The entire functional test can take up to five minutes. Once started, the tests can not be interrupted. Ensure prior to the tests that the battery is not charged above 98% and that the battery state of charge is not 2% above the lower discharge threshold.<br /><br />NOTICE! Damage to the inverter in the event of battery power cable being connected to the incorrect polarity.<br />Make sure that each battery power cable is correctly connected to the inverter. Make also sure that only one or several batteries used as a DC source are connected to the inverter." },
	{ "hContentHelpKiteJPTest","The battery functional test comprises the tests: <b>Battery charging</b> and <b>battery discharging</b>. The tests can be performed in any sequence. The entire functional test can take up to five minutes. Once started, the tests can not be interrupted. Ensure prior to the tests that the battery is not charged above 98% and that the battery state of charge is not 2% above the lower discharge threshold." },
	...
	{ "hContentEnergyMeter","Select the energy meter used in the system on this page. After selecting the energy meter, the inverter will detect the serial number and the state of the energy meter automatically.<br /><br />Select the entry <b>SMA Energy Meter</b> when the inverter is connected to an SMAEnergyMeter. After the selection, all available energy meters are shown in a table. Add the requested energy meter to the system by selecting <b>Settings</b> and <b>Use energy meter in the system for the requested energy meter</b>.<br />Select the entry <b>SMARevenueGradeMeter</b> when the inverter is equipped with an SMARevenueGradeMeterKit (e.g. with inverters of the type SBx.x-1TP-US-40).<br />Select the entry <b>WattNode Modbus RTU</b> when the inverter is connected to a WattNode Modbus energy meter.<br />Select the entry <b>SunSpec Modbus RTU</b> when the inverter is connected to an energy meter that communicates with the inverter via SunSpec Modbus RTU protocol.<br /><br />You must adjust further settings depending on the energy meter." },
	...
	{ "lTimeOfUseDays","Select days of the week" },
	{ "lTimeDomain","Time range" },
	{ "lPlsChrgW","Grid Consumption Limit" },
	{ "lPlsDschW","Grid Feed-In Limit" },
	...
	{ "lTimeOfUseHelpIntro","On this page, you can create performance profiles for the use of different electricity tariffs. Three operating modes can be chosen from regarding the performance profiles. As a result, you can use cheap electricity and reduce your energy bills." },
	...
	{ "lPopPlsLimitFeedin","Nominal feed-in power at the grid connection point. When the set value is reached, charging of the battery with the surplus power is started." },
	{ "lPopPlsLimitFeed","Target reference power at the grid connection point. When the set value is reached, the battery is discharged." },
	{ "lPopTouLimitCharge","Desired charging power of the battery. The power is set independently of the grid connection point." },
	{ "lTimeOfUseHelpContent","<b>Time-controlled power specification (time-of-use)</b><br /><br />This operating mode is used to adapt the charging behavior of the battery to its electricity tariff. <br />You can determine in which time range the battery with a specified charging power is operated.<br /><br /><b>Load-controlled power setpoint at the grid-connection point (peak load shaving)</b><br /><br />This operating mode is used to optimize the battery inverter behavior to the power exchange at the grid-connection point. With this operating mode, certain grid-exchange power outputs to which the battery inverter is adjusted depending on its power and battery capacity available can be set. Power peaks can thus be avoided.  <br /><br /><b>Inactive </b><br />This operating mode is used to deactivate a performance profile temporarily." },
	...
	{ "hConfigureCellular","If you would like to use Cellular, select the option <b>Yes</b> under Cellular.<br />The cellular connection allows the direct data transmission between the inverter and the internet portal SunnyPortal via the cellular network as an alternative to data transmission via Ethernet or WLAN. The cellular connection only transmits a limited amount of data to SunnyPortal. A local network connection is not absolutely necessary, but it is recommended to be able to view all information regarding the system in SunnyPortal.<br />Note the term of the mobile data plan. All costs are covered within the term." },
	...
	{ "lCharging","Charge" },
	{ "lDischarging","Discharge" },
	{ "lStandby","Standby" },
	{ "lForceChargePower","Forced charge power" },
	{ "lBatteryBackupWizardMenu","Configuration of battery / battery-backup system" },
	{ "bNewBatteryBackupCfg","New configuration" },
	{ "hContentHelpKiteNewCfg","Selecting this button is only necessary when changing the system.<br /><br />Select this button when a battery is exchanged or a new battery is added, and when the system is extended to a battery-backup system with an automatic transfer switch." },
	{ "hBatteryNewBackupHelp","Battery-backup system recognized" },
	{ "hContentHelpBackupLink","A battery-backup system has been recognized. Further settings must be made in the \"battery-backup system\" step. Wait until all the connected batteries are recognized and listed in the list." },
	{ "lJetTestWizardMenu","Jet Test" },
	{ "iHeadlineJETTest","Jet Test" },
	{ "bLoad50Hz","50Hz default values" },
	{ "bLoad60Hz","60Hz default values" },
	{ "bDiscard","Discard changes" },
	{ "bJetTestOverVoltageRelay","Over voltage relay" },
	{ "bJetTestUnderVoltageRelay","Under voltage relay" },
	{ "bJetTestOverFrequencyRelay","Over frequency relay" },
	{ "bJetTestUnderFrequencyRelay","Under frequency relay" },
	{ "bJetTestVoltageRiseSuppression","Voltage rise suppression" },
	{ "bJetTestOfflineMode","JET-Offline Mode" },
	{ "lJetTestDetectionLevel","Detection level" },
	{ "lJetTestDetectionTime","Detection time" },
	{ "lJetTestFrequency","Frequency" },
	{ "lJetTestDetectionLevelPU","Detection level P(U)" },
	{ "lJetTestDetectionLevelQU","Detection level reactive power" },
	{ "lJetTestPminNorm","Pmin Norm" },
	{ "lJetTestPassiveIslandingDetection","Passive islanding detection" },
	{ "lJetTestVoltageDropDetection","Voltage drop detection" },
	{ "lJetTestFixedTime","Fixed time" },
	{ "lJetTestInverterPower","Inverter power" },
	{ "lJetTestFrequencyMonitoring","Frequency monitoring" },
	{ "lJetTestIslandDetection","Island detection" },
	{ "lJetTestVoltageMonitoring","Voltage monitoring" },
	{ "lJetTestOtherOption","Other options" },
	{ "lJetTestOptionCosPi","Cos(Phi)" },
	{ "lJetTestOptionOperationMode","Operation mode" },
	{ "lJetTestPowerCurtailmentBox","Power Curtailment Box" },
	{ "lJetTestBoxState","Status" },
	{ "bJetTestBoxConnect","Connect" },
	{ "lNsmTakaWizardMenu","Grid management" },
	{ "bResetParaCounter","Reset operation inhibition" },
	{ "lJetTestStepInjectionDetection","Step injection detection" },
	{ "lJetTestActiveIslandingDetection","Active islanding detection" },
	{ "bJetTestBoxDisconnect","Disconnect" },
	{ "hJetTestHeader","<b>Jet Test Mode</b>" },
	{ "hJetTestContent","Lorem" },
	{ "lShowGridSearching","The inverter synchronizes to the available grid frequency." },
	{ "hJapanNetConfHeader","<b>System configuration</b>" },
	{ "hJapanNetConfContent","Configure the values for Voltage / Frequency monitoring and Voltage rise suppression in accordance with the grid operator's specifications and grid-connection codes JEAC 9701." },
	{ "hJapanPowerboxConfHeader","<b>Power Curtailment Box</b>" },
	{ "hJapanOtherConfHeader","<b>Other options</b>" },
	{ "hJapanOtherConfContent","Set the operating mode from Stop to MPP to operate the inverter." },
	{ "hJapanPowerboxConfContent","Ensure that the inverter's network configuration has been made to connect to a PowerCurtailmentBox.<br />The inverter and PowerCurtailmentBox must be located in the same network." },
	{ "lJetTestFrequencyFeedback","Frequency feedback" },
	{ "lJetTestActiveIslandingDetectionMode","Active islanding detection mode" },
	{ "lChartPowerAndGrid","PV and grid-supplied power" },
	{ "lChartYieldAndGrid","PV yield and grid-supplied power" },
	{ "lPwdUser","User password" },
	{ "lPwdInstallateur","Installer password" },
	{ "lPwdRichtlinien","Password guidelines" },
	{ "lPwdCharSmall","Lower case" },
	{ "lPwdCharBig","Upper case" },
	{ "lPwdCharSign","Number" },
	{ "lPwdCharOther","Special characters ?_!-" },
	{ "lPwdCharCount","8-12 characters" },
	{ "eInstallPasswordNotChangedYetInstaller","No password has been assigned for user group <b>Installer</b>.            <br />The password is also the system password. It is required for system registration in SunnyPortal.            <br />Assign a uniform password to all SMA devices in the system.            <br />        " },
	{ "eNewPassError","The password does not comply with the password guidelines." },
	{ "lNewPass","Password" },
	{ "eInstallPasswordNotChangedYetUser","No password has been assigned for user group <b>User</b>.            <br />If you as a specialist assign a password, pass the password on to the user.        " },
	{ "bSaveLogin","Save and log in" },
	{ "ePassDoNotMatch","The passwords do not match." },
	{ "lPowerControlModuleNA","Grid and PV system protection via SMA I/O Module" },
	{ "helpContentNASchutz","Activate the grid and PV system protection if the inverter is connected to an external monitoring unit with grid and PV system protection relays via the SMA I/O Module." },
	{ "hJapanAIDHeader","<b>AID rate of rise</b>" },
	{ "hJapanAIDContent","The rate of rise is set to <b>High</b> by default. Only change the value if it is required by the transmission system operator or if a flicker problem exists in the system." },
	{ "hManagementInverter","The inverter can limit its active power by the use of a higher unit or fixed default values. If the inverter shall receive the default values via a higher unit (e.g. communication product, I/O module or Modbus), select the operating mode \"Active power limitation P via system control\". When using this operating mode, you can additionally configure how the active power is limited in the event of a communication failure. You can select whether the inverter shall retain the last values received or limit the nominal power of the inverter to the set fallback value once the time-out interval has elapsed. Select whether the inverter shall disconnect from the utility grid when limited to 0% or 0W. This setting is required if the grid operator does not allow the inverter to still feed in a low amount of active power when limited to 0% or 0W." },
	{ "lSeleted","Select" },
	{ "bDownload","Download" },
	{ "lSelectAll","Select all" },
	{ "tFiles","Files" },
	{ "lInformationDevice","Information" },
	{ "lPInverter","Inverter" },
	{ "hFirmwareUpdateTakaP","You can load the update onto your device manually." },
	{ "hBatteryReversePowerRelayHelp","Reverse Power Relay" },
	{ "lReversePowerRelay","Reverse Power Relay" },
	{ "hContentHelpReversePowerRelay","The reverse power play test is a functional test in which the battery is charged and discharged for a short time.<br />The measured values are compared with the energy meter.<br />The functional test <b>must</b> be carried out once during commissioning" },
	{ "bReversePowerRelay","Reverse power relay test" },
	{ "lRPRTestRunning","Test is in progress" },
	{ "hSafetyOffContentHelp","Select <b>Off</b> if you do not want to use the Rapid Shutdown function." },
	{ "hSafetyOtherContentHelp","Select <b>Other</b> if an alternate DC disconnection unit is used (e.g. TS4 or SMA Rapid Shutdown System)." },
	{ "hSafetySunspecShutdownHelp","Select <b>SunSpec Shutdown</b> if the PV array is disconnected with devices in accordance with the SunSpec Rapid Shutdown specification." },
	{ "9999001","Other" },
	{ "9999002","Tigo Cloud Connect Advanced (CCA)" },
	{ "9999003","SMA Rooftop Communication Kit-P2" },
	{ "lAskSecurePowerSupplyInstalled","Is the secure power supply operation enabled?" },
	{ "lAlternateDCDisconnectionDevice","Alternate DC disconnection device" },
	{ "hSafetySettingsHelpOn","Select <b>On</b> if PV array and inverter are disconnected by an additional DC disconnection unit independent of the inverter." },
	{ "hSafetyRabbitShutDownSetting","Rapid Shutdown Setting" },
	{ "hSafetySettingsHelpHeader","<b>Configuring the Rapid Shutdown Function</b>" },
	{ "hSafetySettingsHelp","The Rapid Shutdown function of the inverter must be enabled if the PV modules or PV strings are equipped with an additional DC disconnection unit that disconnects the PV array from the inverter.<br /><br />Select <b>Off</b> if you do not want to use the Rapid Shutdown function." },
	{ "hSafetyTigoSettingsHelp","Select <b>TS4 Shutdown</b> if the PV array is disconnected via TS4 module technology. With TS4-R-F, <b>SunSpec Shutdown</b> must be selected." },
	{ "hSafetySunspecSettingsHelp","Select <b>SunSpec Shutdown</b> if the PV array is disconnected via a module switch in accordance with the SunSpec Interoperability Specification." },
	{ "lSafetyFunctionsHeader","Safety Functions" },
	{ "lSafetyFunctionsWizardMenu","Safety Functions" },
	{ "9999004","Other, i.e. 3rd party rapid shutdown device" },
	{ "lOnlineHelp","eManual" },
	{ "lSmartView","Smart Inverter Screen" },
	{ "1383","Active power is limited by a specified maximum Limit" },
	{ "1500000","SMA Solar Technology AG" },
	{ "1500001","|raw01|" },
	{ "2000000","Gushen" },
	{ "lSmartViewInfo","Can only be activated after the initial start-up by the installation assistant" },
};
#define strings_count sizeof(strings)/sizeof(struct sb_string)
