...
//		{ "charge_amps", "charge_current" },
	...
	JSConstantSpec si_constants[] = {
		...
		JS_NUMCONST(CLUSTER_CONFIG_UNKNOWN),
		JS_NUMCONST(CLUSTER_CONFIG_1PHASE1),
		JS_NUMCONST(CLUSTER_CONFIG_2PHASE2),
		JS_NUMCONST(CLUSTER_CONFIG_2PHASE4),
		JS_NUMCONST(CLUSTER_CONFIG_3PHASE),
		{ 0 }
	};
	JSObject *obj;
