...
#ifdef DEBUG_MEM
extern JS_PUBLIC_API(void *) _js_malloc(JSContext *cx, size_t nbytes, char *file, int line);
extern JS_PUBLIC_API(void *) _js_realloc(JSContext *cx, void *p, size_t nbytes, char *file, int line);
extern JS_PUBLIC_API(void) _js_free(JSContext *cx, void *p, char *file, int line);
extern JS_PUBLIC_API(char *) _js_strdup(JSContext *cx, const char *s, char *file, int line);
#define JS_malloc(c,n) _js_malloc(c,n,__FILE__,__LINE__)
#define JS_realloc(c,p,n) _js_realloc(c,p,n,__FILE__,__LINE__)
#define JS_free(c,p) _js_free(c,p,__FILE__,__LINE__)
#define JS_strdup(c,s) _js_strdup(c,s,__FILE__,__LINE__)
#else
extern JS_PUBLIC_API(void *) JS_malloc(JSContext *cx, size_t nbytes);
extern JS_PUBLIC_API(void *) JS_realloc(JSContext *cx, void *p, size_t nbytes);
