...
int PR_AtomicDecrement(int *val);
#if 0
...
#define PR_NotifyCondVar(cvar) pthread_cond_signal(cvar)
#define PR_NotifyAllCondVar(cvar) pthread_cond_signal(cvar)
#define PR_NewThreadPrivateIndex pthread_key_create
#define PR_GetThreadPrivate pthread_getspecific
#define PR_SetThreadPrivate pthread_setspecific
